...
var bio = {
	...
	"skills" : "<ul /ul>Out of box thinking, <ul /ul> Analytic Thinking, <ul /ul> Results driven,<ul /ul> PMP,<ul /ul> Six Sigma Green Belt",
...
var work = {
	"jobs" : [
	{
		...
		"description" : "Program Manager for the Decommissioning programs being evaluated for movement into the Project Management Organization. Work on the scope, process improvements, work flows and evaluation of acceptance into the PMO. IRPM for 22 State Layer 0/1 Infrastructure builds. A3 team member for process improvement.",		
	},
	{
...
function display(){
	...
	var formattedTitle = HTMLonlineTitle.replace("%data%",projects.projects.title);
...
var education = {
	...
	},
	{
		...
		"degree" : "AA",
		"major" : "Computer Programming/Business Administration",
		"date" : "1975/1976",
